...
const TAB_COMMANDS: Record<Tab, string[]> = {
  ...
  Encrypt: [
    '$ ./encrypt ./docs --mode fork',
    '✓ Encrypted 200 files in 1.02s  [4× speedup via fork]',
    '',
    '$ ./encrypt ./docs --mode thread',
    '✓ Encrypted 200 files in 1.34s',
  ],
  Decrypt: [
    '$ ./decrypt ./docs --mode fork',
    '✓ Decrypted 200 files in 1.05s',
    '',
    '$ ./decrypt ./docs --mode serial',
    '✓ Decrypted 200 files in 4.02s',
  ],
  Help: [
    '$ ./encrypt --help',
    'Usage: ./encrypt <path>',
